...
<body>
  ...
  <div class="content">
    ...
    <div class="top-action">
      <a href="tambah-hotel.php" class="btn-primary">+ Tambah Hotel</a>
    </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <td>
          ...
          <a href="../../../controllers/admin/hotel/hapus-hotel.php?id=<?= $row['id_hotel']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-danger">Hapus</a>
        </td>
