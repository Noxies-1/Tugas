...
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM pesawat WHERE id_pesawat = '$id'");
...
<body>
  <div class="container">
    <h2>🏨 Edit Hotel</h2>
    <form class="admin-form" action="../../../controllers/admin/pesawat/update-pesawat.php" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?= $data['id_pesawat'] ?>">
